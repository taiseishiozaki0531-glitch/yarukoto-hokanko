...
「やること保管庫」は、読書・動画・教材・人間関係・買い物など、日常生活の中で「あとでやろう」と思ったまま放置されがちなものを一箇所に集め、次に取るべき行動まで整理する個人向けWebアプリである。
...
- **Adjacent expectations**: 初期リリースでは、読書・動画・教材・人間関係・買い物をすべて「アイテム」として扱う。カテゴリごとに分離された体験ではなく、共通のアイテム管理体験として提供する。
...
**Objective:** As a 個人ユーザー, I want 後回しにしている読書・動画・教材・人間関係・買い物などをアイテムとして登録できる, so that 頭の中や複数アプリに散らばっている「あとでやること」を一箇所に保存できる
...
4. The system shall カテゴリ候補として読書、動画、教材、人間関係、買い物、その他を選択式で表示する。
...
4. When ユーザーが教材カテゴリを選択したとき, the system shall 教材URL、全体の章数、現在の章、単位章に関する入力欄を表示する。
...
**Objective:** As a 個人ユーザー, I want 総量と現在の進捗から進捗率が自動計算される, so that 読書・動画・教材などの進み具合を視覚的に把握できる
...
5. Where 読書・動画・教材の進捗情報が含まれる, the system shall 現在量を総量で割った割合を進捗率として扱う。
...
**Objective:** As a 個人ユーザー, I want URL付きアイテムから外部ページをすぐ開ける, so that 動画・教材・記事・商品ページなどにすぐアクセスできる
